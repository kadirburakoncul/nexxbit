    ...
    : IRequestHandler<GetStrategiesQuery, Result<List<StrategyDto>>>
{
        ...
        GetStrategiesQuery request, CancellationToken ct)
    {
        ...
        var dtos = strategies.Select(s => new StrategyDto(
            ...
            s.RsiMaxValue,
            s.UseHigherTfConfirm,
            s.HigherTimeframe,
            s.UseRiskBasedSizing,
            s.RiskPerTradePct,
            s.MaxConsecutiveLosses,
            s.PauseOnDrawdownPct,
            s.PausedUntil,
            s.StopLossPct,
            s.TakeProfitPct,
            s.MinVolumeUsdt,
            ...
            s.MaxHoldHours,
            s.SlCooldownHours,
            s.IsGreenCandleFilterEnabled,
            s.IsEma200RuleEnabled,
            s.IsActive,
            s.IsRealTradeEnabled,
            s.IsVolatileMode,
            s.ActivatedAt,
            s.MaxOpenPositions,
            s.MaxPositionSizeUsdt,
            s.MaxPositionSizePct,
            s.MinPositionSizeUsdt,
            s.UseAdxFilter,
            s.AdxPeriod,
            s.AdxMinValue,
            s.UseMacdFilter,
            s.UseBreakevenStop,
            s.BreakevenTriggerPct,
